...
namespace LiferayPush
{
    ...
    interface LRSession
    {
        ...
        ILRAuthentication Authentication { get; set; }
        ...
        IntPtr Constructor(string server, ILRAuthentication authentication);
        ...
        IntPtr Constructor(string server, ILRAuthentication authentication, LRCallback callback);
        ...
        IntPtr Constructor(string server, ILRAuthentication authentication, int connectionTimeout, LRCallback callback);
        ...
        IntPtr Constructor(string server, ILRAuthentication authentication, int connectionTimeout, LRCallback callback, NSOperationQueue queue);
